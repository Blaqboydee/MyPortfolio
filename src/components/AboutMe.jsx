  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className={`flex items-start gap-8 pb-8 border-b ${isDark ? "border-neutral-800" : "border-neutral-200"}`}
      >
      ...
      <motion.div variants={itemVariants} className="space-y-4">
        <p className={`text-sm lg:text-lg leading-relaxed ${isDark ? "text-neutral-300" : "text-neutral-700"}`}>
      ...
      <div className="grid md:grid-cols-2 gap-6 pt-4">
        ...
        <motion.div 
          variants={itemVariants}
          className={`p-4 lg:p-6 rounded-xl border ${isDark ? "border-neutral-800 bg-neutral-900/50" : "border-neutral-200 bg-neutral-50"}`}
        >
        ...
        >
          ...
          <ul className={`space-y-2 ${isDark ? "text-neutral-300" : "text-neutral-700"}`}>
            <li className="flex items-start gap-2">
              ...
              <span className="text-sm lg:text-lg">Deepening my expertise in Next.js and backend integration</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-neutral-500 flex-shrink-0"></span>
              <span className="text-sm lg:text-lg">Building Zaptalk (fullstack chat app)</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-neutral-500 flex-shrink-0"></span>
              <span className="text-sm lg:text-lg">Learning Mobile Development with React Native</span>
            </li>
          </ul>
        </motion.div>
      ...
      <motion.div 
        variants={itemVariants}
        className={`mt-8 pt-6 border-t ${isDark ? "border-neutral-800" : "border-neutral-200"}`}
      >
        <blockquote className={`${isDark ? "text-neutral-400" : "text-neutral-600"} italic text-center lg:text-lg`}>
