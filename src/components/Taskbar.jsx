...
const Taskbar = ({ isDark, toggleTheme }) => {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 ${isDark ? 'bg-black border-neutral-800' : 'bg-white border-neutral-300'} border-t px-4 py-3 flex justify-between items-center`}>
